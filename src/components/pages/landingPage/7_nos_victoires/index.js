...
export default function NosVictoires() {
    ...
    return (
        <div className={classnames(styles.formateurContainer)}>
            ...
            <div className={classnames("container")}>
                <h6 className={classnames(styles.formateurTitle)}><span></span></h6>
                <h3 className={classnames(styles.formateurTeaser)}><span>Le collectif<span
                ...
                <div className={classnames("row")}>
                    <div className={classnames("col ")}>
                        <p className={classnames(styles.formateurDescription)}>
                            <span>👋 &nbsp; Salut, Nous sommes un <strong style={{fontFamily: "CircularStd-Black"}}>collectif d'experts IT</strong></span>
                        </p>
                        <div className={classnames(styles.formateurDescriptionPoints)}>
                            <ul className={classnames(styles.formateurDescriptionPoints)}>
                                ...
                                <li>✷️ &nbsp; Nous sommes certifiés, avec plus de 8 ans d'expérience sur le terrain.</li>
