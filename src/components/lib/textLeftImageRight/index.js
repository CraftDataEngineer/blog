...
export default function TextLeftImageRight({title,titleStyle = stylesModule.title , ponctuation = ".", description,descriptionStyle = stylesModule.description, imageSrc,imageStyle = stylesModule.image,containerStyle= {}}) {
    return (
